<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CitasPendientes.aspx.cs" Inherits="ProyectoClinicaParavida.CitasPendientes" %>
                    ...
                    <div class="card card-header" style="background-color: white;">
                        <div class="row">
                            <div class="col-8">
                                ...
                                <h3 style="margin-left: 10px; color: #6c757ddb;">Citas Pendientes</h3>
                            </div>
                    ...
                    <div class="form-control card card-body" style="background: #f3f3f3;">
                        <fieldset>
                            <div class="text-center" style="margin-top: 15px;">
                                <h4 style="padding: 5px; color: dimgray">LISTA PENDIENTES</h4>
                            </div>
                            <div class="text-center" style="padding-top: 1px; background: #80808040; margin-bottom: 23px;"></div>
                            <div align="center">
                                <asp:GridView ID="GvCitasPendientes" runat="server" BorderWidth="2px" CellPadding="4" CellSpacing="1" ForeColor="#333333" GridLines="None">
